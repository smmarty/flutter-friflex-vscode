...
const createWidget = async (dirName, config) => {
    (0, files_1.checkAvailableConfigInFolder)(dirName, consts_1.configStatelessWidget);
    const editor = vscode.window.activeTextEditor;
    if (!editor) {
        return;
    }
    const filePath = editor.document.fileName;
    const template = await (0, json_1.readTemplateJson)(consts_1.configStatelessWidget);
...
//# sourceMappingURL=create_stateless_widget.js.map