"use strict";
/// Шаблон содержимого файла основного репозитория.
/// Принимает:
...
exports.mainRepositoryTemplate = mainRepositoryTemplate;
const string_1 = require("../utils/string");
/// репозитория, реализующего этот интерфейс.
function mainRepositoryTemplate(featureName, capitalizedFeature) {
    return `import '../../domain/repository/i_${(0, string_1.camelCaseToSnakeCase)(featureName)}_repository.dart';

/// Основной репозиторий реализующий интерфейс I${capitalizedFeature}Repository
class ${capitalizedFeature}Repository implements I${capitalizedFeature}Repository {}`;
}
//# sourceMappingURL=main_repository_template.js.map